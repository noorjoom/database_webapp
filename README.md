...
To create and fill the Database use ```python database.py```
...
```
cd existing_repo
git remote add origin https://git.imp.fu-berlin.de/arveb03/database_webapp.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.imp.fu-berlin.de/arveb03/database_webapp/-/settings/integrations)
